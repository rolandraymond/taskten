...
class UsersService {
    ...
    /**
     * جلب قائمة المستخدمين بصيغة مختصرة للتكليف
     */
    async getAssignmentPickerList() {
        const users = await usersRepository.findAllWithRoles();
        ...
        return users.map((u) => ({
            ...
            avatar: u.avatar_image,
            isAdmin: u.Role ? u.Role.is_admin : false,
        }));
    }
