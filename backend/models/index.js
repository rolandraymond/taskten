...
const TaskAssignment = require('./task_assignment')(sequelize); // 👈 السطر الجديد
...
// 👇👇 Task Assignments Associations 👇👇
Task.belongsToMany(User, {
    through: TaskAssignment,
    as: 'Assignees', // نقدر نجيب الموظفين اللي شغالين عالتاسك
    foreignKey: 'task_id',
    otherKey: 'user_id',
});
...
User.belongsToMany(Task, {
    through: TaskAssignment,
    as: 'AssignedTasks', // نقدر نجيب التاسكات المطلوبة من الموظف
    foreignKey: 'user_id',
    otherKey: 'task_id',
});
// direct association to the join table
...
// عشان نعرف مين الأدمن اللي عمل التكليف
TaskAssignment.belongsTo(User, {
